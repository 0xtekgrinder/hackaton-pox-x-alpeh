...
const headerItems: string[] = ['Address', 'Action'];

const committeeMembers: string[] = ['0xc0ffee254729296a45a3885639AC7E10F9d54979'];

export default function CommitteeTable(): React.ReactNode {
	return (
								...
								<>
									...
									<td className="px-6 py-4">
										<div className={'flex justify-end gap-4'}>
											<a href={'#'}>
												<BiTrash size={30} className={'text-red-700 hover:text-gray-600'} />
											</a>
										</div>
									</td>
								</>
